...
object InvalidModuleException {
	private val serialVersionUID : Long = 14423400234L
}

class InvalidModuleException(private val message : String, private val cause : Throwable) extends Exception {
