...
<a href="#comments" onclick="comment_paging('1', '<?php echo $category; ?>', '<?php echo $article_id; ?>')">First</a> | <?php } ?>

<?php if ($page_num == '0'){ ?>Previous | <?php } else { ?>
<a href="#comments" onclick="comment_paging('<?php echo $page_num2-1; ?>', '<?php echo $category; ?>', '<?php echo $article_id; ?>')">Previous</a> | <?php } ?>

<?php echo $page_num+1; ?> - <?php echo $page_num_max; ?> of <?php echo $or_comments_count; ?> | 

<?php if ($max == TRUE){ ?>Next | <?php } else { ?>
<a href="#comments" onclick="comment_paging('<?php echo $page_num2+1; ?>', '<?php echo $category; ?>', '<?php echo $article_id; ?>')">Next</a> | <?php } ?>

<?php if ($max == TRUE){ ?>Last<?php } else { ?>
<a href="#comments" onclick="comment_paging('<?php echo $comments_count; ?>', '<?php echo $category; ?>', '<?php echo $article_id; ?>')">Last</a><?php } ?>
<br /><br />
					<ul>
