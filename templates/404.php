	...
	<div id="container">
		...
		<?php include('../assets/tpl/sidebar.php'); echo "\n"; ?>
			<div id="content">
				...
				<p>You are on this page because the page you have tried to access
					cannot be found, the reason for this can be on the following:</p>
				<ul>
				...
				<p>
					We suggest going to the <a href="http://www.myrunelog.com">homepage</a>
					or <a href="http://myrunelog.com/contact.php">contact us</a> for
					help directly if this reoccurs.
				</p>
			</div>
