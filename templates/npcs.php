						...
						<table width="100%" border="0">
							<tr>
								<td width="200px"><?php if($article['image'] != '') { ?><img
									src="/images/npcs/<?php echo $article['image']; ?>" alt="" />
								
								
								
								<?php } else { ?><img src="/images/default.png" alt="" /><br /><a href="#">Submit an image</a><?php } ?></td>
								<td width="470px"><b>Notes:</b>
...
<center><h2>Information</h2></center>
	...
	<?php } ?>
				...
				<?php if($article['edit_username'] != ''){ ?>
					<p class="right">
						Last modified on
						<?php echo date("d/m/Y",$article['edit_timestamp']); ?>
						by <a
							href="/community/index.php?/user/<?php echo $article['edit_userid']; ?>-<?php echo $article['edit_username']; ?>/"
							title="Author" class="guide-author"><?php echo $article['edit_username']; ?>
						</a>
					</p>
