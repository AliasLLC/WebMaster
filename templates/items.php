...
<?php include('../assets/tpl/navigation.php'); echo "\n"; ?>
				...
				<div class="article_box">
					<div class="article_box_inner">
						<table width="100%" border="0">
							<tr>
								<td width="200px"><?php if($article['image'] != '') { ?><img
									src="/images/items/<?php echo $article['image']; ?>" alt="" />
								
								
								
								<?php } elseif($no_item !== TRUE) { ?><img src="http://services.runescape.com/m=itemdb_rs/3387_obj_big.gif?id=<?php echo $runescape_id; ?>" alt="" /><br /><a href="#">Submit an image</a><?php } else { ?><img src="/images/default.png" alt="" /><br /><a href="#">Submit an image</a><?php } ?></td>
								<td width="470px">
								<?php if ($article['equips'] == 1) { ?>
									<table width="100%">
										...
										<tr>
											<td width="33%"
												style="border: 1px solid #0f0f0c; padding: 5px;"><b>Attack</b><br />
	...
	<?php if($article['equip_range_att'] != '0') { if($article['equip_range_att'] != '') { ?>Range Attack: <?php echo $article['equip_range_att'].'<br />'; }} ?></td>
											<td width="33%"
												style="border: 1px solid #0f0f0c; padding: 5px;"><b>Defence</b><br />
	...
	<?php if($article['equip_range_def'] != '0') { if($article['equip_range_def'] != '') { ?>Range Defence: <?php echo $article['equip_range_def'].'<br />'; }} ?></td>
											<td width="33%"
												style="border: 1px solid #0f0f0c; padding: 5px;"><b>Other</b><br />
...
<?php } ?></td>
										...
										<tr>
											<td width="100%" colspan="3"
												style="border: 1px solid #0f0f0c; padding: 5px;">
												<table width="100%">
													<tr>
														<td width="33%"><?php if($article['weight'] != '') { ?><b>Weight:</b>
														
														
														
														 <?php echo $article['weight'].'kg<br /><br />'; } ?></td>
														<td colspan="2" width="66%"><?php if($article['equip_attack_speed'] != '0') { ?>
															<center>
																Attack Speed<br />
	...
	<?php echo '<img src="/images/item_speed/'.$article['equip_attack_speed'].'.png" alt="" />'; ?><br /></center>
									...
									</table> <br />Equipment Slot: <?php echo $article['equip_slot']; ?>
								</td>
							</tr>
						</table>
					</div>
				...
				<div class="article_box" style="margin-top: 20px;">
					<div class="article_box_inner">
						...
						<?php yes_no($article['stackable']) ?>
							Stackable |
							<?php yes_no($article['tradeable']) ?>
							Tradeable |
							<?php yes_no($article['equips']) ?>
							Equipable |
							<?php yes_no($article['members']) ?>
							Members<br /> <br />
						</center>
