...
$comments = mysql_query("SELECT ko_comments.*, ipb_profile_portal.*, ipb_members.* FROM ko_comments, ipb_profile_portal, ipb_members WHERE ko_comments.article_id = '$article_id' AND ko_comments.status = 'published' AND ipb_profile_portal.pp_member_id = ko_comments.user_id AND ipb_members.member_id = ko_comments.user_id AND ko_comments.article_category = '$category' ORDER BY ko_comments.likes DESC LIMIT $page_num, ".$settings['max_page_comments']."");

// Count comments
$comments_c = mysql_query("SELECT ko_comments.*, ipb_profile_portal.*, ipb_members.* FROM ko_comments, ipb_profile_portal, ipb_members WHERE ko_comments.article_id = '$article_id' AND ko_comments.status = 'published' AND ipb_profile_portal.pp_member_id = ko_comments.user_id AND ipb_members.member_id = ko_comments.user_id AND ko_comments.article_category = '$category' ORDER BY ko_comments.likes DESC");
